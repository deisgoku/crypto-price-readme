  ...
  return (
    <div className="unlock-wrapper p-4">
      <div className="unlock-card bg-white p-6 rounded-xl shadow-lg max-w-md mx-auto">
        ...
        <div className="w-full max-w-md mx-auto space-y-4">
          ...
          <div className="form-group">
            <input
              ...
              className="w-full p-3 rounded-md bg-gray-100 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>
        ...
        {/* Unlocked URL Section */}
        {unlockedUrl && (
          <div className="form-group mt-6 text-center">
            <p className="subtitle text-gray-700 font-semibold mb-2">Your Card URL:</p>

            <code className="block my-2 p-2 w-full rounded break-words break-all text-xs bg-white text-gray-800">
              {unlockedUrl}
            </code>
            ...
            <div className="flex justify-center gap-4 mt-4">
              <button
                ...
                className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md transition active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center gap-4 bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md transition active:scale-95"
              >
                <ClipboardCopy className="w-4 h-4" />
                Copy HTML
              </button>
