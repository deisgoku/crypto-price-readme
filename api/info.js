...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const themeHeader = `
      ...
      <path d="
        M 8 ${headerY}
        H ${colWidth[0] + colWidth[1]}
        V ${headerY + rowHeight}
        H 8
        A 8 8 0 0 1 0 ${headerY + rowHeight - 8}
        V ${headerY + 8}
        A 8 8 0 0 1 8 ${headerY}
        Z
      " fill="url(#aurora)" />
    ...
    const modelHeader = `
      <path d="
        M ${colWidth[0] + colWidth[1]} ${headerY}
        H ${colWidth[0] + colWidth[1] + colWidth[2] - 8}
        A 8 8 0 0 1 ${colWidth[0] + colWidth[1] + colWidth[2]} ${headerY + 8}
        V ${headerY + rowHeight - 8}
        A 8 8 0 0 1 ${colWidth[0] + colWidth[1] + colWidth[2] - 8} ${headerY + rowHeight}
        H ${colWidth[0] + colWidth[1]}
        Z
      " fill="url(#aurora)" />
