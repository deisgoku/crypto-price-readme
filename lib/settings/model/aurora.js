...
const renderAurora = (data, theme = 'tokyonight', limit = 10) => {
  ...
  const header = `
    <g transform='translate(0, 40)'>
      ...
      <text x='${svgWidth / 2}' y='20' text-anchor='middle' ${fontHeader} fill='${textColor}' opacity='0.7'>
        Github Crypto Market Card — Category: ${categoryText}
      </text>
    </g>
  `;
  ...
  const footer = `
    <text x="${svgWidth / 2}" y="${footerY}" text-anchor="middle" ${fontFooter1} fill="${textColor}" opacity="0.7">
      ${year} © All Rights Reserved — Crypto-Price-Readme v1.5.9 (AURORA)
    </text>
