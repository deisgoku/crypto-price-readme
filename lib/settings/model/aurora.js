  ...
  const rows = data.slice(0, limit).map((coin, i) => {
    ...
    if (i === 0) {
      badge = `<g transform="translate(${badgeX}, 8) scale(1.3)">
        <path d="M10 2 L12.4 8.6 L19.5 8.6 L13.9 12.9 L16.3 19.5 L10 15 L3.7 19.5 L6.1 12.9 L0.5 8.6 L7.6 8.6 Z"
      ...
      badge = `<g transform="translate(${badgeX}, 9) scale(1.3)">
        <path d="M12 2C10 5 12 7 10 10C8 12.5 10.5 15 13 15C16 15 18 12 17.5 9C17 5.5 13 5 14 1C14.5 -0.5 12 0 12 0Z" 
