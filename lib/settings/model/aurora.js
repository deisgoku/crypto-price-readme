...
const renderAurora = (data, theme = 'tokyonight', limit = 10) => {
  ...
  const rows = data.slice(0, limit).map((coin, i) => {
    ...
    if (i === 0) {
      badge = `<g transform="translate(${badgeX}, 8) scale(1.3)">
        <path d="M12 2L14.09 8.26L21 9.27L16 14.14L17.18 21.02L12 17.77L6.82 21.02L8 14.14L3 9.27L9.91 8.26L12 2Z"
          fill="#FFD700" filter="url(#icon-shadow)"/>
      </g>`;
    } else if (i === 1) {
      badge = `<g transform="translate(${badgeX}, 8) scale(1.3)">
        <path d="M12 2L13.8 7.6L19.8 8.3L15.4 12.4L16.5 18.5L12 15.6L7.5 18.5L8.6 12.4L4.2 8.3L10.2 7.6L12 2Z"
          fill="#C0C0C0" filter="url(#icon-shadow)"/>
      </g>`;
    } else if (i === 2) {
      badge = `<g transform="translate(${badgeX}, 8) scale(1.3)">
        <path d="M12 2L13.2 6.8L18.5 7.3L14.5 11.2L15.4 16.6L12 14L8.6 16.6L9.5 11.2L5.5 7.3L10.8 6.8L12 2Z"
          fill="#CD7F32" filter="url(#icon-shadow)"/>
      </g>`;
    } else if (i === 3) {
      badge = `<g transform="translate(${badgeX}, 9) scale(1.3)">
        <path d="M12 2C10 4 10 7 12 10C10 9 8 10 8 12C8 14.5 10 16 12 18C14 16 16 14.5 16 12C16 10 14 9 12 10C14 7 14 4 12 2Z"
          fill="url(#flame-gradient)" filter="url(#icon-shadow)"/>
      </g>`;
    }
