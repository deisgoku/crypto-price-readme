...
const renderModern = (data, theme = 'dark', limit = 6, category = '') => {
  const {
  ...
  const header = `
    <g transform="translate(0, 40)">
      ...
      <text x="${svgWidth / 2}" text-anchor="middle" y="22" font-size="12" fill="${textColor}" font-family="monospace" opacity="0.6">
  ...
  const tableHead = `
    <g transform="translate(20, 60)">
      <rect x="10" y="0" width="560" height="${headerHeight}" rx="${borderRadius}" fill="${headBg}" stroke="${rowBorder}" />
