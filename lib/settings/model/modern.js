...
const renderModern = (data, theme = 'dark', limit = 10) => {
  ...
  const fontTableHead = `font-family="Arial" font-size="13px" font-weight="bold"`;
  const fontRow = `font-family="monospace" font-size="13px"`;
  const fontFooter1 = `font-family="monospace" font-size="13px" font-weight="bold"`;
  const fontFooter2 = `font-family="monospace" font-size="13px"`;
