...
const renderModern = (data, theme = 'dark', limit = 6) => {
  ...
  const headPaddingBottom = 20; // awal 10
  ...
  <text x="${xTrend + (maxTrendLength * charWidth)}" y="${tableHeadY + 15}" ${font} fill="${headText}" text-anchor="${textAnchorConfig.Trend}" font-weight="bold">Trend</text>
