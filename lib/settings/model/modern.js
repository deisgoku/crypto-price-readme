...
const renderModern = (data, theme = 'dark', limit = 10) => {
  ...
  // FONT CONFIG
  const fontHeader = `font-family="Verdana" font-size="16px" font-weight="bold"`; // Title
  const fontSubHeader = `font-family="Verdana" font-size="13px"`; // Category subtitle
  const fontTableHead = `font-family="Arial" font-size="13px"`; // Table headers
  const fontRow = `font-family="monospace" font-size="13px"`; // Table data
  const fontFooter = `font-family="monospace" font-size="13px"`; // Footer
