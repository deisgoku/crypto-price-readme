...
const gradients = {
  trendDownGradient: {
    id: "trendDownGradient",
    stops: [
      { offset: "0%", color: "#ff595e", opacity: 0.2 },
      { offset: "100%", color: "#ff595e", opacity: 0.02 },
    ],
  },
  trendUpGradient: {
    id: "trendUpGradient",
    stops: [
      { offset: "0%", color: "#00c46a", opacity: 0.2 },
      { offset: "100%", color: "#00c46a", opacity: 0.02 },
    ],
  },
};
